...
const A_LETS_GO_INTRO_COPY = () => {
  return (
    <div className="between-text">
      ...
      >
        <div className="text">
          <ParkIcon sx={{ fontSize: "1em", padding: "40px", margin: "auto" }} />
          ...
          <div className="body-content">
            ...
            <p>
              Every season offers visitors a different experience. Depending on
              your travel needs and goals, figuring out when and where to visit
              can be a challenge.
            </p>
